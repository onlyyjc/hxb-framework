package com.hxb.core.common.http;

import com.hxb.core.common.mapper.JsonMapper;
import com.hxb.core.common.utils.CharsetUtils;
...
//		String url = "http://paytest.hanxinbank.com/anon/zhima/callback";
...
//		  
//		try {
//			// System.out.println(makeQueryString1(null, params, DEFAULT_CHARSET));
//			System.out.println(makeQueryString(null, params, DEFAULT_CHARSET));
//		} catch (UnsupportedEncodingException e) {
//			e.printStackTrace();
//		}
//		String respString  = rest.postForJsonRaw(url,JsonMapper.toJsonString(params));
